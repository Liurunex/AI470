"""
Q2: Implement and apply Two layer neural network classifiers                                    #
"""
...
# We will use the class TwoLayerNet in the file CPSC470/classifiers/neural_net.py to represent instances of our network. 
...
from CPSC470.classifiers.neural_net import TwoLayerNet
...
# Open the file CPSC470/classifiers/neural_net.py and look at the method TwoLayerNet.loss. 
...
# Implement the rest of the function. This will compute the gradient of the loss with respect to the variables W1, b1, W2, and b2. 
...
from CPSC470.gradient_check import eval_numerical_gradient
...
# You will also have to implement TwoLayerNet.predict, as the training process periodically performs prediction to keep track 
...
# Tuning. Tuning the hyperparameters and developing intuition for how they affect the final performance is a large part of using Neural Networks, s
