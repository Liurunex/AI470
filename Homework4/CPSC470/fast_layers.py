import numpy as np
try:
  from CPSC470.im2col_cython import col2im_cython, im2col_cython
except ImportError:
  print('run the following from the CPSC470 directory and try again:')
  print('python3 setup.py build_ext --inplace')
  print('You may also need to restart your iPython kernel')

from CPSC470.im2col import *
